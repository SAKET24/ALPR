...
def detectCharsInPlates(listOfPossiblePlates):
    ...
    output=0 
#   
#    if len(listOfPossiblePlates) == 1:          # if list of possible plates is empty
#        print("In DetectChars",listOfPossiblePlates)
#        listOfPossiblePlates.imgGrayscale, listOfPossiblePlates.imgThresh = Preprocess.preprocess(listOfPossiblePlates)
#        cv2.imwrite("TestingGray.jpg",listOfPossiblePlates.imgGrayscale)
#        output = image_to_string(Image.open("TestingGray.jpg").convert("RGB"), lang='eng')
#        return listOfPossiblePlates,output             # return
#    # end if
#
...
#    i="1"
    ...
    #        print("Debugging PossiblePlate: ",possiblePlate.imgPlate)
            ...
            cv2.imwrite("TestingGray.jpg",possiblePlate.imgGrayscale)
             
            output = image_to_string(Image.open("TestingGray.jpg").convert("RGB"), lang='eng')
#            print("Printing Plate Info....",output)
            if (output!=""):
#                return output
                break
    #        print("1.Debugging PossiblePlate: ",possiblePlate.imgPlate)
    #        print("2.Debugging PossiblePlate: ",possiblePlate.imgGrayscale)
    #        print("3.Debugging PossiblePlate: ",possiblePlate.imgThresh)
    #        
            ...
            #possiblePlate.imgThresh = cv2.resize(possiblePlate.imgThresh, (1,1), fx = 0, fy = 0)#me
            #cv2.imshow("TestingThresh2",possiblePlate.imgThresh)#me
            #print("4.Debugging PossiblePlate: ",possiblePlate.imgThresh)
            # threshold again to eliminate any gray areas
            thresholdValue, possiblePlate.imgThresh = cv2.threshold(possiblePlate.imgThresh, 1.0, 255.0, cv2.THRESH_BINARY | cv2.THRESH_OTSU)
            #cv2.imshow("TestingThresh",possiblePlate.imgThresh)#me
    #        print("Debugging PossiblePlates: ",possiblePlate.imgThresh)
    #        print("Debugging PossiblePlates(GreyScale): ",possiblePlate.imgGrayscale)
            if Main.showSteps == True: # show steps ###################################################
            ...
            # end if # show steps #####################################################################
    #        print("Debugging:ListOfPossibleCharInPlate:",listOfPossibleCharsInPlate)
                    # given a list of all possible chars, find groups of matching chars within the plate
            listOfListsOfMatchingCharsInPlate = findListOfListsOfMatchingChars(listOfPossibleCharsInPlate)
    #        print("Debugging:ListOfListOfMatchingCharInPlate:",listOfListsOfMatchingCharsInPlate)
            if Main.showSteps == True: # show steps ###################################################
                imgContours = np.zeros((height, width, 3), np.uint8)
                del contours[:]
            ...
            if (len(listOfListsOfMatchingCharsInPlate) == 1):			# if no groups of matching chars were found in the plate
            ...
            for i in range(1, len(listOfListsOfMatchingCharsInPlate)):                              # within each list of matching chars
    ...
    #        print("Printing listOfListsOfMatchingCharsInPlate")
    #        print("Printing the length of list: ",len(listOfListsOfMatchingCharsInPlate))
            for i in range(0, len(listOfListsOfMatchingCharsInPlate)):
                if len(listOfListsOfMatchingCharsInPlate[i]) > intLenOfLongestListOfChars:
                    intLenOfLongestListOfChars = len(listOfListsOfMatchingCharsInPlate[i])
                    print(i)
                    intIndexOfLongestListOfChars = i
                    print(intIndexOfLongestListOfChars)
                # end if
            # end for
    ...
    return listOfPossiblePlates,output
# end function
...
def checkIfPossibleChar(possibleChar):
    ...
    #print("Inside Check IF Possible")
...
def recognizeCharsInPlate(imgThresh, listOfMatchingChars):
    ...
    for currentChar in listOfMatchingChars:                                         # for each char in plate
        ...
        try:
            strCurrentChar = str(chr(int(npaResults[1][1])))            # get character from results
        except IndexError:
            break
